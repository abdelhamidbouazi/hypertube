    ...
    <article className="space-y-8 text-left">
      ...
      <header className="space-y-2">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          A Hypertube-inspired web app for searching and watching movies with a
          clean, modern UX.
        </p>
      </header>
      ...
      <section className="rounded-2xl border border-gray-200 bg-white/70 p-5 shadow-sm backdrop-blur dark:border-gray-800 dark:bg-gray-900/60">
        ...
        <p className="leading-relaxed text-gray-700 dark:text-gray-300">
          <strong>Cinéthos</strong> lets users{" "}
          <span className="font-semibold">search</span>,{" "}
          <span className="font-semibold">stream</span>, and
          <span className="font-semibold"> explore</span> movies directly in the
          browser. The player streams while the server downloads, ensuring
          minimal waiting time and an enjoyable experience.
        </p>
      </section>
      ...
      <section className="rounded-2xl border border-gray-200 bg-white/70 p-5 shadow-sm backdrop-blur dark:border-gray-800 dark:bg-gray-900/60">
        ...
        <p className="leading-relaxed text-gray-700 dark:text-gray-300">
          We wanted to craft a secure, performant, and elegant streaming
          experience using modern best practices—pushing ourselves across
          frontend, backend, and deployment. Cinéthos is our take on a
          production-ready, scalable app that respects the Hypertube subject
          rules.
        </p>
      </section>
      ...
      <section className="rounded-2xl border border-gray-200 bg-white/70 p-5 shadow-sm backdrop-blur dark:border-gray-800 dark:bg-gray-900/60">
        ...
        <p className="mb-3 text-gray-700 dark:text-gray-300">
          We use the latest tooling and stick to the subject’s requirements for
          search, streaming, security, and API design. Light &amp; dark modes
      ...
      <section className="rounded-2xl border border-gray-200 bg-white/70 p-5 shadow-sm backdrop-blur dark:border-gray-800 dark:bg-gray-900/60">
        ...
        <ul className="list-disc space-y-1 pl-5 text-gray-700 dark:text-gray-300">
          <li>
            Authenticated library with search and thumbnails (sorted,
            filterable, paginated).
          </li>
          <li>
            Video details page with player, metadata, comments, and on-the-fly
            streaming.
          </li>
          <li>
            Server-side download/cleanup policy and subtitles per user language
            when available.
          </li>
          <li>
            Secure forms, no plain-text passwords, input validation, and safe
            uploads.
          </li>
          <li>
            Public REST API with OAuth2 for users, movies, and comments (per
            spec).
          </li>
