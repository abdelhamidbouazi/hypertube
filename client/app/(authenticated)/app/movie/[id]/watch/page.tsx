...
export default function WatchPage({ params }: WatchPageProps) {
  ...
  const { movie, isLoading, error } = useMovieDetails(unwrappedParams.id);
      ...
      <div className="min-h-screen bg-gradient-to-br from-background to-content2">
        <div className="container mx-auto px-4 py-8">
          <div className="flex items-center justify-center min-h-[400px]">
            <Spinner label="Loading movie..." size="lg" />
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-content2">
      <div className="container mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-6">
          <Link href={`/app/movie/${unwrappedParams.id}`}>
            <Button startContent={<ArrowLeft size={16} />} variant="flat">
              Back to Movie
            </Button>
          </Link>
            ...
            >
              ...
              <div className="relative w-full h-full flex items-center justify-center">
                <div className="text-center transform transition-transform duration-300 hover:scale-105">
                  ...
                  <p className="text-foreground-500 text-lg mb-2">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-foreground text-sm bg-content1/50 px-2 py-1 rounded">
                        {playbackSpeed}x
                      </span>
                    </div>
